...
export default function AmplifiersPage() {
  ...
  const amplifiers = products.filter(product => 
    product.category === 'dacs-amps' && 
    product.subcategory === 'amplifiers'
  );

  const sortedProducts = [...amplifiers].sort((a, b) => {
    if (sortBy === 'price') {
  ...
  return (
    <div className="container mx-auto px-4 pt-24 pb-16">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold">耳机放大器</h1>
